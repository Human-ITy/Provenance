...
cd /d "%ROOT%"
"%EXE%" --cert-causal-world-exposure
set RESULT=%ERRORLEVEL%
if exist "Docs\provenance_causal_world_geologic_exposure_cert.txt" type "Docs\provenance_causal_world_geologic_exposure_cert.txt"
exit /b %RESULT%
