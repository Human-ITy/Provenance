...
cd /d "%ROOT%"
"%EXE%" --cert-causal-world-differential-erosion
set RESULT=%ERRORLEVEL%
if exist "Docs\provenance_causal_world_differential_erosion_cert.txt" type "Docs\provenance_causal_world_differential_erosion_cert.txt"
exit /b %RESULT%
