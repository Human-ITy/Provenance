...
- **Pick / surface continued testing:** `PICK_FRACTURE_HANDOFF.md` — `--cert-pick-fracture`; sky/clear in|around hole = FAIL (no mouth exception); P5a freeze; P5b.1 FROZEN one-way; P5b.2A state-only (P5b.2B/P5b.3 closed).
