...
| **P5** Water | P5a ledger freeze; **P5b.1 FROZEN** one-way; **P5b.2A FROZEN** state-only; **P5b.2B FROZEN** bounded pore; **P5b.2C FROZEN** occupancy. **P5b.3A FROZEN** hydraulic detachment (choice A local loose). **P5b.3B CERTIFIED** hydraulic transport of already-detached loose matter. **P5b.3C CLOSED** | See `PROVENANCE_PIN.md` / `P5B3B_HYDRAULIC_TRANSPORT_HANDOFF.md` |
...
- **Pick / surface continued testing:** `PICK_FRACTURE_HANDOFF.md` — `--cert-pick-fracture`; sky/clear in|around hole = FAIL (no mouth exception); P5a freeze; P5b.1 FROZEN one-way; P5b.2A FROZEN state-only; P5b.2B/P5b.2C FROZEN; **P5b.3A FROZEN** (choice A local loose); **P5b.3B CERTIFIED** (one-hop loose transport); **P5b.3C closed**.
