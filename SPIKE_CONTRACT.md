...
| **P5** Water | P5a ledger freeze; **P5b.1 one-way terrain→water** | See `PROVENANCE_PIN.md` / `P5B1_TERRAIN_WATER_HANDOFF.md` |
...
- **Pick / surface continued testing:** `PICK_FRACTURE_HANDOFF.md` — `--cert-pick-fracture`; sky/clear in|around hole = FAIL (no mouth exception); P5a freeze; P5b.1 one-way only (P5b.2/P5b.3 closed).
