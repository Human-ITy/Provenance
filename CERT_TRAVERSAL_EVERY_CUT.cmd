...
REM EVERY CUT: cardinal replacement on the latest play stage (16C.1).
...
if exist "Docs\provenance_16c1_cardinal_replacement_cert.txt" type "Docs\provenance_16c1_cardinal_replacement_cert.txt"
popd
exit /b %RESULT%
