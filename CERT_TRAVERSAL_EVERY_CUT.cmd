...
REM EVERY CUT: cardinal replacement on the latest play stage (P5b.3B.3A).
...
if exist "Docs\provenance_p5b3b3a_cardinal_replacement_cert.txt" type "Docs\provenance_p5b3b3a_cardinal_replacement_cert.txt"
popd
exit /b %RESULT%
