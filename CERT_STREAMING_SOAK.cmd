...
REM First-landing 90 s Test B on latest play stage (P5b.3B.3B). Stop/return off.
...
REM 3B.3A control remains --cert-streaming-soak-p5b3b3a. P5b.3C stays CLOSED.
...
if exist "Docs\provenance_p5b3b3b_streaming_soak_cert.txt" type "Docs\provenance_p5b3b3b_streaming_soak_cert.txt"
popd
exit /b %RESULT%
