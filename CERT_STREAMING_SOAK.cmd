...
REM First-landing 90 s Test B on latest play stage (P5b.3B.2). Stop/return off.
...
REM 3B control remains --cert-streaming-soak-p5b3b. P5b.3C / 3B.3 stay CLOSED.
...
if exist "Docs\provenance_p5b3b2_streaming_soak_cert.txt" type "Docs\provenance_p5b3b2_streaming_soak_cert.txt"
popd
exit /b %RESULT%
