...
REM First-landing 90 s Test B on latest play stage (P5b.3B.3A). Stop/return off.
...
REM 3B.2 control remains --cert-streaming-soak-p5b3b2. P5b.3C / 3B.3B stay CLOSED.
...
if exist "Docs\provenance_p5b3b3a_streaming_soak_cert.txt" type "Docs\provenance_p5b3b3a_streaming_soak_cert.txt"
popd
exit /b %RESULT%
