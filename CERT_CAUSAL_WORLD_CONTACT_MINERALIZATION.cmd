...
cd /d "%ROOT%"
"%EXE%" --cert-causal-world-contact-mineralization
set RESULT=%ERRORLEVEL%
if exist "Docs\provenance_causal_world_contact_mineralization_cert.txt" type "Docs\provenance_causal_world_contact_mineralization_cert.txt"
exit /b %RESULT%
