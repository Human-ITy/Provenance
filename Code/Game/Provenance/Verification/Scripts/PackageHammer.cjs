...
const derived=path.join(root,'output/integration/hammer_v001');
const dest=path.join(repo,'Data/Provenance/Tools/Hammer/v001');
const prefix='data://provenance/tools/hammer/v001/';
