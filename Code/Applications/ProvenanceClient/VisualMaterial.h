...
namespace VisualMat
{
    ...
    inline VisualMaterialDef const* Table( int& outCount )
    {
        static VisualMaterialDef const kDefs[] = {
            ...
            // FableScript WorldSubstrate substance IDs. These are appearance
            // mappings only: the engine material identity remains unchanged.
            { "alluvium", Family::Aggregate, BodyForm::GranularDrift, EdgeBehavior::SlumpRound,
              FractureCharacter::LooseCollapse, MergeBehavior::SmoothDeposit, Microrelief::FineRipple,
              SurfaceTexture::FineGranular, WetnessResponse::DarkenCompact,
              { 126, 116, 76, 158, 146, 96 },
              "mixed channel sediment", "low cohesive bars and channel deposits" },
            { "colluvium", Family::Aggregate, BodyForm::AggregatePile, EdgeBehavior::IrregularBroken,
              FractureCharacter::CoarseRubble, MergeBehavior::AggregatePile, Microrelief::ChunkyPebble,
              SurfaceTexture::CoarseRocky, WetnessResponse::PatchySparkle,
              { 108, 94, 72, 138, 120, 88 },
              "mixed slope debris", "irregular slope mantle and pockets" },
            { "metamorphic", Family::Metamorphic, BodyForm::FoliatedMass, EdgeBehavior::PlanarDirectional,
              FractureCharacter::FoliationSplit, MergeBehavior::DirectionalContinuous, Microrelief::SheetFlake,
              SurfaceTexture::MicaceousDirectional, WetnessResponse::PlaneSpecular,
              { 92, 96, 94, 126, 130, 124 },
              "directional metamorphic rock", "coherent foliated formation" },
            { "organic_mineral", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 58, 58, 42, 86, 82, 56 },
              "dark mineral soil", "organic-capable mineral mantle; not vegetation" },
            { "quartzite", Family::Metamorphic, BodyForm::MassiveBlock, EdgeBehavior::BlockyJointed,
              FractureCharacter::AngularBlocks, MergeBehavior::MassiveBody, Microrelief::CrystallineRough,
              SurfaceTexture::HardCrystalline, WetnessResponse::CrackSpecular,
              { 164, 158, 148, 202, 196, 184 },
              "hard crystalline rock", "massive resistant jointed body" },
            { "scoria", Family::Igneous, BodyForm::AggregatePile, EdgeBehavior::IrregularBroken,
              FractureCharacter::CoarseRubble, MergeBehavior::AggregatePile, Microrelief::WeatheredPits,
              SurfaceTexture::CoarseRocky, WetnessResponse::DeepSlick,
              { 74, 52, 44, 108, 72, 56 },
              "vesicular volcanic rubble", "rough porous volcanic deposit" },
            { "silt", Family::Aggregate, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SmoothDeposit, Microrelief::FineRipple,
              SurfaceTexture::FineGranular, WetnessResponse::DarkenCompact,
              { 126, 112, 84, 154, 138, 104 },
              "fine mineral sediment", "smooth low-relief depositional mantle" },
            { "talus", Family::Aggregate, BodyForm::AggregatePile, EdgeBehavior::IrregularBroken,
              FractureCharacter::CoarseRubble, MergeBehavior::AggregatePile, Microrelief::ChunkyPebble,
              SurfaceTexture::CoarseRocky, WetnessResponse::PatchySparkle,
              { 112, 108, 102, 146, 140, 130 },
              "angular coarse rock debris", "piles below resistant faces" },
            { "tuff", Family::Igneous, BodyForm::BeddedLedge, EdgeBehavior::SoftenedLedge,
              FractureCharacter::BlockyBedding, MergeBehavior::FormationContinuous, Microrelief::WeatheredPits,
              SurfaceTexture::WeatheredLayered, WetnessResponse::DampStreak,
              { 142, 126, 104, 174, 154, 126 },
              "lithified volcanic ash", "softened coherent volcanic beds" },
            { "weathered_rock", Family::Aggregate, BodyForm::SoftMantle, EdgeBehavior::IrregularBroken,
              FractureCharacter::CoarseRubble, MergeBehavior::FormationContinuous, Microrelief::WeatheredPits,
              SurfaceTexture::WeatheredLayered, WetnessResponse::DarkenCompact,
              { 128, 112, 88, 158, 138, 106 },
              "weathered parent-rock mantle", "retains formation ancestry under regolith" },
            ...
            // MW8 diagnostic ecological-regime visualization only — not vegetation.
            { "biome_alpine_barren", Family::Igneous, BodyForm::MassiveBlock, EdgeBehavior::BlockyJointed,
              FractureCharacter::AngularBlocks, MergeBehavior::MassiveBody, Microrelief::CrystallineRough,
              SurfaceTexture::HardCrystalline, WetnessResponse::CrackSpecular,
              { 214, 216, 220, 232, 234, 236 },
              "diagnostic alpine barren regime",
              "MW8 biome authority; not snowpack or vegetation" },
            { "biome_alpine_tundra", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 156, 168, 148, 178, 188, 168 },
              "diagnostic alpine tundra potential",
              "MW8 biome authority; not living plants" },
            { "biome_subalpine", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 92, 128, 108, 118, 152, 128 },
              "diagnostic subalpine transition",
              "MW8 biome authority; not trees" },
            { "biome_moist_forest", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 42, 98, 62, 62, 122, 78 },
              "diagnostic cool moist forest potential",
              "MW8 biome authority; not spawned trees" },
            { "biome_dry_woodland", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::GrainyFace,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 148, 132, 78, 168, 150, 92 },
              "diagnostic dry interior woodland/scrub potential",
              "MW8 biome authority; not shrubs" },
            { "biome_riparian", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 48, 138, 92, 68, 162, 108 },
              "diagnostic riparian corridor regime",
              "MW8 biome authority; not streamside plants" },
            { "biome_wet_meadow", Family::Soil, BodyForm::SoftMantle, EdgeBehavior::RoundedCrumbly,
              FractureCharacter::Clods, MergeBehavior::SeamlessSoil, Microrelief::CrumbPores,
              SurfaceTexture::EarthySoft, WetnessResponse::DarkenTacky,
              { 88, 148, 72, 112, 168, 90 },
              "diagnostic wet meadow / marsh potential",
              "MW8 biome authority; not grass" },
            { "biome_basin_wetland", Family::Sedimentary, BodyForm::BeddedLedge, EdgeBehavior::SoftenedLedge,
              FractureCharacter::BlockyBedding, MergeBehavior::FormationContinuous, Microrelief::WeatheredPits,
              SurfaceTexture::ChalkyStone, WetnessResponse::DampStreak,
              { 48, 92, 108, 68, 116, 132 },
              "diagnostic basin wetland regime",
              "MW8 biome authority; not standing water" },
            { "biome_dry_rocky", Family::Igneous, BodyForm::MassiveBlock, EdgeBehavior::BlockyJointed,
              FractureCharacter::AngularBlocks, MergeBehavior::MassiveBody, Microrelief::CrystallineRough,
              SurfaceTexture::HardCrystalline, WetnessResponse::CrackSpecular,
              { 168, 148, 128, 188, 168, 146 },
              "diagnostic dry rocky slope regime",
              "MW8 biome authority; not a lithology paint" },
        };
